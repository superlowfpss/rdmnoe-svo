using Content.Shared._Custom.CustomCCVars;
using Content.Shared._Custom.TapePlayer;
using Robust.Client.GameObjects;
using Robust.Shared.Configuration;

namespace Content.Client._Custom.TapePlayer
{
    public sealed class TapePlayerSystem : SharedTapePlayerSystem
    {
        ...
        public override void Initialize()
        {
            ...
            _cfg.OnValueChanged(CustomCCVars.TapePlayerClientEnabled, OnTapePlayerClientOptionChanged, true);
        }

        public override void Shutdown()
        {
            base.Shutdown();
            _cfg.UnsubValueChanged(CustomCCVars.TapePlayerClientEnabled, OnTapePlayerClientOptionChanged);
        }
